      ...
      <main className="min-h-screen">
        ...
        <div className="relative w-full h-[50vh] z-10">
          ...
          <div className="relative flex flex-col justify-center items-center h-full text-center">
            <h1 className="text-white text-5xl font-bold mb-4 transform hover:scale-105">Security</h1>
        ...
        <div className="flex flex-col md:flex-row relative z-10">
          {/* Left Column */}
          <div className="w-full md:w-1/2 bg-[#002B4E] text-white p-12 lg:p-16 transition-transform transform hover:scale-105 cursor-pointer">
            <h2 className="text-3xl lg:text-4xl font-bold mb-6">Highly Skilled & Professional Team</h2>
          ...
          {/* Right Column */}
          <div className="w-full md:w-1/2 bg-white p-12 lg:p-16 text-blue-900 transition-transform transform hover:scale-105 cursor-pointer">
            <h2 className="text-3xl lg:text-4xl font-bold mb-6">Commitment to Excellence & Reliability</h2>
            <p className="leading-relaxed">
              At SWC Security, we are dedicated to providing the highest standard of security solutions, underpinned by
        ...
        <div className="mx-auto px-4 relative bg-white z-10 border-2 border-blue-900 shadow-xl transition-transform transform hover:scale-105 ">
          <div className="mx-auto flex">
            <h2 className="text-3xl text-center py-12 px-10 transform  w-[50%] whitespace-nowrap lg:text-4xl font-bold text-[#002B4E] mb-6">Serving Melbourne</h2>
            <p className="text-blue-900 px-14 py-16 leading-relaxed w-[50%] cursor-pointer">
              SWC Security proudly serves Melbourne, offering comprehensive security solutions tailored to the unique
